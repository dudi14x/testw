        ...
        <div className="rounded-2xl p-8 md:p-10 bg-white/5 backdrop-blur-xl border border-white/10 shadow-[0_25px_80px_rgba(0,0,0,0.6)]">
          ...
          <div className="mt-8 pt-8 border-t border-white/10">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <a
                href={`mailto:${CONTACT_EMAIL}`}
                className="px-4 py-2 rounded-lg bg-white/5 border border-white/10 text-cyan-400 hover:bg-white/10 hover:border-cyan-400/30 transition-all text-sm focus:outline-none focus:ring-2 focus:ring-cyan-400 focus:ring-offset-2 focus:ring-offset-black"
