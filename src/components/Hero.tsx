  ...
  return (
    ...
    >
      <div className="hero-content animate-fade-in-up">
        ...
        <p className="text-xl md:text-2xl text-gray-400 mb-8 font-light hero-subtitle">
          AI & Machine Learning Enthusiast
        </p>
        <p className="text-base md:text-lg text-gray-500 max-w-2xl mx-auto leading-relaxed font-bold hero-description">
